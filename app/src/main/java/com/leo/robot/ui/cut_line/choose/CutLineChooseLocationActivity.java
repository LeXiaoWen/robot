...
public class CutLineChooseLocationActivity extends NettyActivity<CutLineChooseLocationActivityPresenter> implements View.OnTouchListener {
    ...
    protected void bindingDagger2(@Nullable Bundle bundle) {
        DaggerCutLineChooseLocationActivityComponent.create().inject(this);
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cut_line_choose_location);
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_back:
                if (!mPresenter.isFastDoubleClick()) {
                    startActivity(new Intent(CutLineChooseLocationActivity.this, CutLineActivity.class));
                    finish();
                }
                break;
        }
